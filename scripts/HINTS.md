...
Пока это **P0**, а не полный порт движка. Не перенесены в этом этапе `baseT/rest`, поиск до 4 ножек, альтернативы маршрутов, полноценный сегментный crowding-feedback и полный экономический блок.
