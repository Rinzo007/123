...
def test_average_connection_wait_is_schedule_aware():
    ...
    assert average_connection_wait_minutes(10, 20, upstream_offset=0, downstream_offset=0, upstream_run_time=10) == 5.0
    assert average_connection_wait_minutes(10, 20, upstream_offset=0, downstream_offset=5, upstream_run_time=10) == 10.0
