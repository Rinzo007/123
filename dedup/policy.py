...
Направления удерживаются жадно по убыванию весов (GHS/POI); при равном весе
...
Такое направление удаляется по общим правилам (минимальный GHS, при равном
GHS — меньший ID). Число таких схлопнутых пар доступно через
