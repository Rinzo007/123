...
def build_pipeline_result(
    *,
    ...
    return PipelineResult(
        ...
        bbox=spatial.bbox,
        ghs_stats=enrichment.ghs_stats,
        ghs_meta=enrichment.ghs_meta,
        ghs_dir_stats=enrichment.ghs_dir_stats,
        built_s_stats=enrichment.built_s_stats,
        built_s_meta=enrichment.built_s_meta,
        built_s_dir_stats=enrichment.built_s_dir_stats,
